...
export const KINDS: KindMeta[] = [
  {
    ...
    rules: [
      ...
      loc("失焦才说空，不要边敲边骂", "Claim empty on blur, not while typing"),
    ],
    spec: loc(
  ...
  },
  {
    ...
    spec: loc(
      "做「所在城市」下拉选择。默认「请选择」，选项为几个省会，只能选一个，不提供搜索，点中即关。",
...
export const FORMULA = [
  ...
  },
  {
    n: "2",
    title: loc("场景", "Scene"),
    example: loc("填邮箱、写一段、比较三档，还是从两百人里找", "An email, a brief, three tiers, or one person among two hundred"),
  },
  {
    n: "3",
    title: loc("规则", "Rules"),

...
tools/study-films/       shim: explainer films live in sibling LightWeaver
```
...
| Study stills / explainer films | LightWeaver `products/study-films/` → `studies/<slug>/references/` (`make films`) |

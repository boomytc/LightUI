...
export function SegmentedDemo({ defaultTab }: { defaultTab?: string } = {}) {
  ...
  return (
    <Window title={locale === "en" ? "North Shop · metrics" : "North Shop · 经营数据"}>
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        <div
          ...
          className="relative flex rounded-full bg-surface-2 p-1"
        >
          <span
            aria-hidden="true"
          ...
          {SEGMENTED_TABS.map((item) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "relative z-[1] min-w-12 rounded-full px-3 py-1.5 text-[12px] transition-colors",

...
export function DemoShell({
  ...
  return (
    <div
      data-guide-page
      data-guide-compact={compact ? "" : undefined}
      className={cn(
        "relative isolate flex min-w-0 flex-col overflow-hidden border border-border bg-surface",
        compact
...
export const Btn = forwardRef<HTMLButtonElement, BtnProps>(function Btn(
  { tone = "primary", className, type = "button", ...props },
  ref,
) {
  return (
    <button

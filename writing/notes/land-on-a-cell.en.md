...
Divide the offset by the radius, clamp onto the circle, smooth, then land on a 12×3 cell. Center is the middle cell. A hop cuts; it does not dissolve. A blink does not change the look vector — it is the other row of the same cell.

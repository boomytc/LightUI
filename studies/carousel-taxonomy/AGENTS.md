...
- Playground window fills the content column. Kinds sit in a cut map
  (glyph tiles) above the stage; a naive-vs-this-cut strip sits under
  the title; spec sits in a compact strip under the stage.

...
```bash
npm run dev          # http://127.0.0.1:5221/
...
- `src/layouts/` — seven page skeletons in a full-width window (scan table of skeletons on top)
...
- Bind the standalone server to `127.0.0.1:5221`.
